...
Lab 9, Example 4: Plot the trajectory of a 2D random walk

Objective: A walker is walking on a 2D plane. At each step, he once flips a coin
          to determine whether to go forward or backward along the x axis, and
          once to determine whether to go forward or backward along the y axis.
